...
const CasesScreen = () => {
    ...
    const casesProducts = products.filter(product => product.category === "Gabinetes")
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 className='title-text-color'>Gabinetes</h1>
        </div>
      </div>
      {
        loading ? (
            ...
            <div className="alert" role="alert">
              ...
              <hr />
              <p className="mb-0">¡Pronto tendremos nuevas gabinetes en stock!</p>
            </div>
          </div>
        )
      }
