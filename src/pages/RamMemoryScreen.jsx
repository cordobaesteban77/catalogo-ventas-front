...
const RamMemoryScreen = () => {
    ...
    const ramProducts = products.filter(product => product.category === "Memorias ram")
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 className='title-text-color'>Memorias ram</h1>
        </div>
      </div>
      {
        loading ? (
            ...
            <div className="alert" role="alert">
              ...
              <hr />
              <p className="mb-0">¡Pronto tendremos nuevas memorias ram en stock!</p>
            </div>
          </div>
        )
      }
...
export default RamMemoryScreen