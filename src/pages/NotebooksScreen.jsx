...
const NotebooksScreen = () => {
    ...
    const notebookProducts = products.filter(product => product.category === "Notebooks")
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 className='title-text-color'>Notebooks</h1>
        </div>
      </div>
      {
        loading ? (
            ...
            <div className="alert" role="alert">
              ...
              <hr />
              <p className="mb-0">¡Pronto tendremos nuevas notebooks en stock!</p>
            </div>
          </div>
        )
      }
