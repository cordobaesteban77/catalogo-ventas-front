...
const MotherScreen = () => {
    ...
    const motherProducts = products.filter(product => product.category === "Mothers")
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 className='title-text-color'>Mothers</h1>
        </div>
      </div>
      {
        loading ? (
            ...
            <div className="alert" role="alert">
              ...
              <hr />
              <p className="mb-0">¡Pronto tendremos nuevas mothers en stock!</p>
            </div>
          </div>
        )
      }
