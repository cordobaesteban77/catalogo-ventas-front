...
const CpuScreen = () => {
    ...
    const cpuProducts = products.filter(product => product.category === "Procesadores")
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 className='title-text-color'>Procesadores</h1>
        </div>
      </div>
      {
        loading ? (
            ...
            <div className="alert" role="alert">
              ...
              <hr />
              <p className="mb-0">¡Pronto tendremos nuevas procesadores en stock!</p>
            </div>
          </div>
        )
      }
