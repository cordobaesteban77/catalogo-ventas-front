...
const PeripheralsScreen = () => {
    ...
    const peripheralsProducts = products.filter(product => product.category === "Perifericos")
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 className='title-text-color'>Perifericos</h1>
        </div>
      </div>
      {
        loading ? (
            ...
            <div className="alert" role="alert">
              ...
              <hr />
              <p className="mb-0">¡Pronto tendremos nuevas perifericos en stock!</p>
            </div>
          </div>
        )
      }
