        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12 d-flex gap-3 justify-content-center mt-2">
              <a href="https://www.instagram.com/_estebancordoba/?next=%2F" target='blank' className='custom-icon'><i className="bi bi-instagram fs-3"></i></a>
              <a href="tel: +5493816463774" target='blank'><i className="bi bi-whatsapp fs-3"></i></a>
              <a href="mailto: cordobaesteban77@gmail.com" target='blank'><i className="bi bi-envelope fs-3"></i></a>
            </div>
