    ...
    <div>
      <footer className='bg-black py-5 mt-4 text-white'>
        <div className="container-fluid">
          <div className="row">
            <div className="col-12 col-lg-6 d-flex flex-column align-items-center justify-content-center text-center gap-3"> 
            ...
            <div className="col-12 col-lg-6 d-flex flex-column gap-3 justify-content-center align-items-center">
